...
<header
	...
	style="background: {scrolled
		? 'rgba(8,8,8,0.82)'
		: 'rgba(8,8,8,0.45)'}; backdrop-filter: blur(16px); -webkit-backdrop-filter: blur(16px); border-bottom: {scrolled
		? '1px solid #1E1E1E'
...
>
	<div
		class="max-w-[1400px] mx-auto flex items-center justify-between px-6 md:px-10 h-[68px]"
	>
		...
		<a
			...
			style="background: #E8500A; color: #fff; padding: 12px 22px; border-radius: 100px; font-size: 14px; font-weight: 600; letter-spacing: -0.01em; transition: transform .2s ease, box-shadow .2s ease; box-shadow: 0 8px 26px -10px rgba(232,80,10,0.6);"
			onmouseenter={(e) => {
